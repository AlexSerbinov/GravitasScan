...
const { USER_SKIPPED_BY_LOW_HF, USER_SKIPPED_BY_HIGH_HF, USER_SKIPPED_BY_LOW_COLLATERAL, USER_SKIPPED_BY_LOW_BORROW, USER_ACCEPTED, SIMULATION_RESULT, SIMULATION_ERROR, PROVIDER_ERROR, USERS_SKIPPED_BY_TO_DIFFERENT_HF, USERS_SKIPPED_BY_FILTERS } = require("../../../../configs/loggerTopicsConstants")
    ...
    try {
      ...
      filteredUsers.forEach(filteredUser => {
        ...
        if (user && !error) {
          ...
          // console.log(`user: ${lowercaseUser} [accepted]`);
