...
const { USER_SKIPPED_BY_LOW_HF, USER_SKIPPED_BY_HIGH_HF, USER_SKIPPED_BY_LOW_COLLATERAL, USER_SKIPPED_BY_LOW_BORROW, USER_SKIPPED_BY_FILTERS, USER_ACCEPTED, SIMULATION_RESULT, SIMULATION_ERROR, PROVIDER_ERROR } = require("../../../../configs/eventTopicsConstants")
      ...
      for (const userData of usersData) {
        try {
          if (filteredUsers.length + scippedUsers.length == usersData.length - 1) {
            ...
            this.emit("info", `all [skipped] users by some of filiter param:  ${scippedUserAddresses.join(", ")}`, USER_SKIPPED_BY_FILTERS)
