...
module.exports = {
  async checkDBArchive(protocol) {  //TODO @AlexSerbinov - remove
    try {
  ...
  async checkDBConnection() { //TODO @AlexSerbinov - remove
    try {
  ...
  async syncDB() { //TODO @AlexSerbinov - remove
    try {
  ...
  async syncDBArchive() { //TODO @AlexSerbinov - remove
    try {
  ...
  async checkNodeConnection() { ////TODO @AlexSerbinov - move to utils
    try {
