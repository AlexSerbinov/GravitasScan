    ...
    try {
      ...
      for (const userData of usersData) {
        try {
          ...
          this.emit("info", `+user [accepted]: ${user}, HF: ${calcHealthFactor}, totalCollateralETH: ${totalCollateralETHB.dividedBy(10 ** 18).toString()}, totalBorrowsETH: ${totalBorrowsETHB.dividedBy(10 ** 18).toString()}`, USER_ACCEPTED)
        } catch (e) {
