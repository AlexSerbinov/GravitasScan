...
class Fetcher extends EventEmitter {
   ...
   */
  async loadUsersReserves({ addresses, blockTag = "19482303" }) {
  ...
  async fetchSubgraphUsers(usersData) {
    ...
    if (!this.blockNumber) this.blockNumber = 19482303 // TODO REMOVE THIS!!!

    const filteredUsers = await this.loadUsersReserves({
      addresses: usersData, blockTag: this.blockNumber
    })
